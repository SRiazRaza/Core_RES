...
{
    public partial class rptDistributor : Form
    {
        DateTime StartDate;
        DateTime EndDate;
        String find;
        public rptDistributor(DateTime startDate, DateTime endDate, String a)
        {
            InitializeComponent();
            StartDate = startDate;
            EndDate = endDate;
        ...
        private void rptDistributor_Load(object sender, EventArgs e)
        {
              LoadReport();
        }
